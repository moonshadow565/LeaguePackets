...
namespace LeaguePackets.CommonData
{
    ...
    {
        public static FXCreateGroupData ReadFXCreateGroupData(this PacketReader reader)
        {
        ...
        public static void WriteFXCreateGroupData(this PacketWriter writer, FXCreateGroupData data)
        {

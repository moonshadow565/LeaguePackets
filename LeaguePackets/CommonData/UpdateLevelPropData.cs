...
namespace LeaguePackets.CommonData
{
    public abstract class UpdateLevelPropData
    {
        ...
        public static UpdateLevelPropData CreateBody(PacketReader reader)
        {
        ...
        public void WriteBody(PacketWriter writer)
        {
    ...
    {
        public static UpdateLevelPropData ReadUpdateLevelPropData(this PacketReader reader)
        {
            return UpdateLevelPropData.CreateBody(reader);
        }
        public static void WriteUpdateLevelPropData(this PacketWriter writer, UpdateLevelPropData data)
        {
